...
namespace MagicVillavillaAPI.Migrations
{
    ...
    [Migration("20230122155229_AddForeignKeyToVillaTable")]
            ...
            modelBuilder.Entity("MagicVilla_villaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 1, 22, 21, 52, 29, 469, DateTimeKind.Local).AddTicks(2184),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 1, 22, 21, 52, 29, 469, DateTimeKind.Local).AddTicks(2196),
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 1, 22, 21, 52, 29, 469, DateTimeKind.Local).AddTicks(2198),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 1, 22, 21, 52, 29, 469, DateTimeKind.Local).AddTicks(2199),
                            Details = "As we all know, a paragraph is a",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 1, 22, 21, 52, 29, 469, DateTimeKind.Local).AddTicks(2200),
                            Details = "As we all know, a paragraph is a",
